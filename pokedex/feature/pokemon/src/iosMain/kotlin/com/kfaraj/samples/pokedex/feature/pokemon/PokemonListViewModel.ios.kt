...
/**
 * The current value of [PokemonListViewModel.itemSnapshotList].
 */
public val PokemonListViewModel.itemSnapshotListValue: ItemSnapshotList<PokemonListItemUiState>
    get() = itemSnapshotList.value
