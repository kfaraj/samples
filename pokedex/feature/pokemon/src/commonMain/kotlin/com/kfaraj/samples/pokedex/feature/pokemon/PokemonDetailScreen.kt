...
import com.kfaraj.samples.pokedex.core.ui.util.stringResource
 ...
 */
@Composable
internal fun SharedTransitionScope.PokemonDetailScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = uiState.id?.let { stringResource(Res.string.number, it) } ?: "",
